...
const 함수명3 = function (매개변수1, 매개변수2) {
  //여기서 function은 이름이 없고 그냥 함수명3에 할당되어 있는 상태(익명함수 상태)
};

//화살표 함수
//규칙
//1. 매개변수가 1개이면, 괄호() 생략 가능
//2. 실행문이 1줄이면, 중괄호 {} 생략 가능
//3. 중괄호 {} 생략시, 값만 입력하면 return 값이 됨
//4. 중괄호 {} 생략하지 않고 return을 사용시, return 키워드 사용
